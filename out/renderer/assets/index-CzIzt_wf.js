...
const toggleZenMode = (enable, type = "brown") => {
  ...
  filter.type = "lowpass";
  filter.frequency.value = type === "brown" ? 400 : 1e3;
...
const Icons = {
  Chart: () => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor", className: "w-4 h-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fillRule: "evenodd", d: "M2.25 13.5a.75.75 0 0 1 .75-.75h2.25a.75.75 0 0 1 .75.75v6.75a.75.75 0 0 1-.75.75H3a.75.75 0 0 1-.75-.75v-6.75ZM8.625 10.5a.75.75 0 0 1 .75-.75h2.25a.75.75 0 0 1 .75.75v9.75a.75.75 0 0 1-.75.75h-2.25a.75.75 0 0 1-.75-.75V10.5ZM15 3a.75.75 0 0 1 .75.75v16.5a.75.75 0 0 1-.75.75h-2.25a.75.75 0 0 1-.75-.75V3.75a.75.75 0 0 1 .75-.75H15Z", clipRule: "evenodd" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M19.5 6a.75.75 0 0 0-.75.75v13.5a.75.75 0 0 0 .75.75h2.25a.75.75 0 0 0 .75-.75V6.75a.75.75 0 0 0-.75-.75h-2.25Z" })
  ] }),
  Settings: () => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor", className: "w-4 h-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fillRule: "evenodd", d: "M11.078 2.25c-.917 0-1.699.663-1.85 1.567L9.05 5.389c-.42.18-.81.406-1.174.675l-2.106-.601c-.879-.25-1.821.205-2.153 1.055l-.957 2.454c-.332.85.121 1.807.962 2.165l2.09.89a7.55 7.55 0 0 0 0 2.285l-2.09.889c-.841.358-1.294 1.315-.962 2.165l.957 2.454c.332.85 1.274 1.304 2.153 1.055l2.106-.601c.363.268.753.494 1.174.675l.178 1.572c.151.904.933 1.567 1.85 1.567h2.556c.917 0 1.699-.663 1.85-1.567l.178-1.572c.42-.18.81-.406 1.174-.675l2.106.601c.879.25 1.821-.205 2.153-1.055l.957-2.454c.332-.85-.121-1.807-.962-2.165l-2.09-.89a7.55 7.55 0 0 0 0-2.285l2.09-.889c.841-.358 1.294-1.315.962-2.165l-.957-2.454c-.332-.85-1.274-1.304-2.153-1.055l-2.106.601c-.363-.268-.753-.494-1.174-.675l-.178-1.572C15.333 2.913 14.55 2.25 13.633 2.25h-2.556Zm-3.085 7.234a.75.75 0 0 1 .53.22L10.5 11.69l1.977-1.978a.75.75 0 0 1 1.06 1.06L11.561 12.75l1.978 1.977a.75.75 0 0 1-1.06 1.06L10.5 13.811l-1.977 1.978a.75.75 0 0 1-1.06-1.06L9.439 12.75 7.462 10.773a.75.75 0 0 1 .531-1.289Z", clipRule: "evenodd" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" })
  ] })
};
const CustomTitleBar = ({ toggleAnalytics, toggleSettings }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-8 bg-gray-900/50 backdrop-blur-md flex items-center justify-between px-4 border-b border-white/5 titlebar-drag-region z-50", children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] font-bold tracking-widest text-white/30 uppercase", children: "Focus Planner OS" }),
  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 no-drag items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: toggleAnalytics, className: "text-white/50 hover:text-emerald-400 transition-colors p-1", title: "Analytics", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icons.Chart, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: toggleSettings, className: "text-white/50 hover:text-blue-400 transition-colors p-1", title: "Settings", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icons.Settings, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-[1px] h-3 bg-white/10 mx-1" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => window.api?.minimize(), className: "w-3 h-3 rounded-full bg-yellow-500/80 hover:bg-yellow-400" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => window.api?.maximize(), className: "w-3 h-3 rounded-full bg-green-500/80 hover:bg-green-400" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => window.api?.close(), className: "w-3 h-3 rounded-full bg-red-500/80 hover:bg-red-400" })
  ] })
] });
function FocusMode({ playlist, settings, onTaskComplete, onSessionComplete, onExit }) {
  const [currentTrackIndex, setCurrentTrackIndex] = reactExports.useState(0);
  ...
  const [timeLeft, setTimeLeft] = reactExports.useState(currentTask.duration * 60);
  const isProcessingComplete = reactExports.useRef(false);
  reactExports.useEffect(() => {
  ...
  reactExports.useEffect(() => {
    ...
    if (status === "active" && currentTask.duration > 0) {
      setEndTime((/* @__PURE__ */ new Date()).getTime() + currentTask.duration * 60 * 1e3);
    }
  }, [currentTrackIndex, status, currentTask]);
  reactExports.useEffect(() => {
    if (status !== "active" || !endTime) return;
    const interval = setInterval(() => {
      const remainingSeconds = Math.ceil((endTime - (/* @__PURE__ */ new Date()).getTime()) / 1e3);
  ...
  reactExports.useEffect(() => {
    ...
    if (endTime) {
      ...
      for (let i = currentTrackIndex + 1; i < playlist.length; i++) {
        ...
        accTime += t.duration * 60 * 1e3;
      }
    }
    let widgetData = { title: currentTask.title, color: currentTask.color, timeLeft, status, queue };
    if (currentTask.type === "break") {
      widgetData.title = "Micro-Break";
      widgetData.color = "bg-blue-500";
    }
    if (status === "transition") {
      widgetData.title = "Done!";
      widgetData.timeLeft = 0;
      widgetData.color = "bg-emerald-500";
    }
    if (status === "completed") {
      widgetData.title = "Finished!";
      widgetData.timeLeft = 0;
    }
    window.api.sendTimerUpdate(widgetData);
    return () => {
      if (window.api) window.api.sendTimerUpdate({ status: "idle" });
    };
  }, [timeLeft, status, currentTask]);
  reactExports.useEffect(() => {
    if (window.api) window.api.onWidgetCommand((cmd) => {
      if (cmd === "stop") onExit();
    });
  }, []);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-screen w-screen bg-gray-900 flex flex-col items-center justify-center relative overflow-hidden font-sans text-white titlebar-drag-region", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `absolute w-[800px] h-[800px] rounded-full blur-[120px] opacity-20 animate-pulse ${status === "transition" ? "bg-emerald-500" : currentTask.color}` }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "z-10 text-center space-y-6 no-drag", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "uppercase tracking-[0.3em] text-white/40 text-sm font-semibold", children: currentTask.type === "break" ? "RECHARGE" : `TASK ${currentTrackIndex + 1} OF ${playlist.length}` }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-6xl font-bold tracking-tight", children: status === "transition" ? `Up Next: ${playlist[currentTrackIndex + 1]?.title}` : currentTask.title }),
      status === "transition" ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-9xl font-bold text-emerald-400 animate-bounce py-8", children: "✓" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[12rem] leading-none font-bold text-transparent bg-clip-text bg-gradient-to-b from-white to-white/50 font-mono", children: formatTime(timeLeft) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-4 justify-center mt-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onExit, className: "px-8 py-3 rounded-full bg-red-500/10 border border-red-500/20 text-red-400 hover:bg-red-500/20 transition-all", children: status === "completed" ? "Exit" : "Stop Session" }) })
    ] })
  ] });
}
function AnalyticsView({ history, onClose }) {
  ...
  const heatmap = Array.from({ length: 14 }, (_, i) => {
    ...
    if (mins > 300) intensity = 4;
    return { date: d.getDate(), intensity };
  });
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-black/80 backdrop-blur-xl z-50 flex items-center justify-center p-8 animate-in fade-in zoom-in duration-200", onClick: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-900 border border-white/10 rounded-2xl w-full max-w-2xl p-8 space-y-8", onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold text-white", children: "Productivity Pulse" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onClose, className: "text-white/50 hover:text-white", children: "✕" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/5 rounded-xl p-6 border border-white/5 flex flex-col items-center justify-center relative overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `absolute inset-0 opacity-20 bg-gradient-to-tr ${score > 80 ? "from-emerald-500" : "from-blue-500"} to-transparent` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-6xl font-bold text-white mb-2", children: score }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs uppercase tracking-widest text-white/50", children: "Daily Focus Score" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/5 rounded-xl p-6 border border-white/5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs uppercase tracking-widest text-white/50 mb-4", children: "14 Day Streak" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-7 gap-2", children: heatmap.map((day, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-8 h-8 rounded-md transition-all ${day.intensity === 0 ? "bg-white/5" : day.intensity === 1 ? "bg-emerald-900" : day.intensity === 2 ? "bg-emerald-700" : day.intensity === 3 ? "bg-emerald-500" : "bg-emerald-400 shadow-[0_0_10px_#34d399]"}` }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-white/20", children: day.date })
        ] }, i)) })
      ] })
    ] })
  ] }) });
...
function SettingsView({ settings, onUpdate, onClose }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-black/80 backdrop-blur-xl z-50 flex items-center justify-center p-8", onClick: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-900 border border-white/10 rounded-2xl w-96 p-8 space-y-6", onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-white", children: "Settings" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-4 bg-white/5 rounded-lg", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-medium", children: "Zen Mode" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-white/40", children: "Play ambient rain during focus" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => onUpdate("zenMode", !settings.zenMode), className: `w-12 h-6 rounded-full transition-colors relative ${settings.zenMode ? "bg-blue-500" : "bg-gray-700"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `absolute top-1 w-4 h-4 bg-white rounded-full transition-all ${settings.zenMode ? "left-7" : "left-1"}` }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-4 bg-white/5 rounded-lg", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-medium", children: "Smart Breaks" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-white/40", children: "Auto-insert 5m break after 1h tasks" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => onUpdate("smartBreaks", !settings.smartBreaks), className: `w-12 h-6 rounded-full transition-colors relative ${settings.smartBreaks ? "bg-blue-500" : "bg-gray-700"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `absolute top-1 w-4 h-4 bg-white rounded-full transition-all ${settings.smartBreaks ? "left-7" : "left-1"}` }) })
      ] })
    ] })
  ] }) });
}
const HorizonsView = ({ onBack, monthlyTasks, setMonthlyTasks }) => {
  ...
  const [inputState, setInputState] = reactExports.useState({});
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-screen w-screen bg-gray-950 p-8 flex flex-col animate-in fade-in zoom-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400", children: "Future Horizons" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-6 flex-1 overflow-hidden pb-4", children: buckets.map((bucket) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col bg-white/5 border border-white/5 rounded-2xl p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold text-white mb-1", children: bucket.label }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-white/30 uppercase tracking-widest mb-4", children: bucket.id !== "later" ? bucket.id : "No Date" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto space-y-2 mb-4 pr-2", children: [
        (monthlyTasks[bucket.id] || []).map((task) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group flex items-center justify-between p-3 bg-white/5 rounded-lg hover:bg-white/10 border border-transparent hover:border-white/10 transition-all", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-white/80", children: task.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
        ...
        (monthlyTasks[bucket.id] || []).length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white/20 text-sm italic text-center py-4", children: "Empty" })
      ] }),
...
function DraggableTask({ id, title, duration, color, onUpdateDuration, onSetDuration, onDelete, onSaveTemplate, isTemplate }) {
  const { attributes, listeners, setNodeRef, transform } = useDraggable({ id, data: { title, duration, color, originalId: id, isTemplate } });
  const style = transform ? { transform: CSS.Translate.toString(transform), zIndex: 999 } : void 0;
  const [isEditing, setIsEditing] = reactExports.useState(false);
  const [editValue, setEditValue] = reactExports.useState(duration);
  ...
  const handleSave = () => {
    ...
    if (!isNaN(val) && val > 0) onSetDuration(id, val);
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ref: setNodeRef,
      style,
      className: "relative p-4 mb-3 rounded-xl bg-white/5 border border-white/10 shadow-sm hover:bg-white/10 group transition-all select-none",
      onContextMenu: (e) => {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-white/90", children: title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `h-2 w-2 rounded-full ${color} shadow-[0_0_8px_currentColor]` })
        ] }),
        !isTemplate && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 bg-black/20 rounded-lg p-1 border border-white/5 relative z-20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onPointerDown: (e) => {
            e.stopPropagation();
            onUpdateDuration(id, -15);
          }, className: "w-6 h-6 flex items-center justify-center rounded hover:bg-white/10 text-white/50 hover:text-white", disabled: duration <= 1, children: "-" }),
          isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsx("input", { ref: inputRef, type: "number", value: editValue, onChange: (e) => setEditValue(e.target.value), onBlur: handleSave, onKeyDown: handleKeyDown, onPointerDown: (e) => e.stopPropagation(), className: "w-[3rem] bg-transparent text-xs font-bold text-white text-center focus:outline-none border-b border-blue-500" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { onContextMenu: handleRightClick, className: "text-xs font-bold text-white min-w-[3rem] text-center cursor-context-menu hover:text-blue-400 transition-colors", title: "Right-click to edit exact time", children: formatDuration(duration) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onPointerDown: (e) => {
            e.stopPropagation();
            onUpdateDuration(id, 15);
          }, className: "w-6 h-6 flex items-center justify-center rounded hover:bg-white/10 text-white/50 hover:text-white", children: "+" })
        ] }) }),
        isTemplate && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 text-[10px] text-white/30 uppercase tracking-widest", children: [
          "Template • ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onPointerDown: (e) => {
          e.stopPropagation();
          onDelete(id);
        }, className: "absolute -top-2 -right-2 p-1 rounded-full bg-red-500 text-white opacity-0 group-hover:opacity-100 transition-opacity z-30 shadow-lg scale-75 hover:scale-100", children: "×" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ...listeners, ...attributes, className: "absolute inset-0 cursor-grab active:cursor-grabbing z-10" })
      ]
    }
  );
}
function TimelineSlot({ index, startTime, endTime, tasksInSlot, onRemoveTask }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: setNodeRef, className: `relative pl-32 border-l border-white/10 h-32 transition-colors duration-200 ${isActive} flex flex-col`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `absolute -left-[5px] top-0 h-2.5 w-2.5 rounded-full ${totalUsed > 0 ? "bg-blue-400 shadow-[0_0_10px_#60a5fa]" : "bg-gray-700"}` }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute -left-28 top-[-6px] flex flex-col items-end w-24", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-white/90 font-mono font-bold", children: formatTime(startTime) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-white/30 font-mono", children: formatTime(endTime) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-3 w-full border-t border-dashed border-white/5" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 w-full flex flex-col gap-[1px] overflow-hidden", children: [
      tasksInSlot.map((task, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `w-full relative group ${task.color} bg-opacity-20 border-l-2 border-white/20 hover:bg-opacity-30`, style: { height: `${task.duration / 60 * 100}%` }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center h-full px-4 gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-white text-sm truncate", children: task.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] text-white/50 bg-black/20 px-1.5 rounded", children: [
            task.duration,
            "m"
          ] }),
          task.type === "break" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] bg-blue-500/50 px-1 rounded uppercase", children: "Break" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => onRemoveTask(index, task.instanceId), className: "absolute right-2 top-1/2 -translate-y-1/2 p-1 bg-black/40 text-white/70 hover:text-white rounded-full opacity-0 group-hover:opacity-100", children: "×" })
      ] }, i)),
      remaining > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1" })
    ] })
  ] });
}
function App() {
  const [view, setView] = reactExports.useState("session");
  const [isSidebarOpen, setSidebarOpen] = reactExports.useState(true);
  const [sidebarTab, setSidebarTab] = reactExports.useState("backlog");
  const [planBaseTime, setPlanBaseTime] = reactExports.useState(/* @__PURE__ */ new Date());
  const [targetHours, setTargetHours] = reactExports.useState(6);
  const [tasks, setTasks] = reactExports.useState(loadData("tasks", [{ id: "1", title: "Reply to Emails", duration: 15, color: "bg-blue-400" }]));
  const [templates, setTemplates] = reactExports.useState(loadData("templates", []));
  const [history, setHistory] = reactExports.useState(loadData("history", []));
  const [settings, setSettings] = reactExports.useState(loadData("settings", { zenMode: false, smartBreaks: true }));
  const [monthlyTasks, setMonthlyTasks] = reactExports.useState(() => loadData("monthlyTasks", {}));
  const [schedule, setSchedule] = reactExports.useState({});
  const [newTaskInput, setNewTaskInput] = reactExports.useState("");
  ...
  reactExports.useEffect(() => saveData("tasks", tasks), [tasks]);
  reactExports.useEffect(() => saveData("templates", templates), [templates]);
  reactExports.useEffect(() => saveData("history", history), [history]);
  reactExports.useEffect(() => saveData("settings", settings), [settings]);
  reactExports.useEffect(() => saveData("monthlyTasks", monthlyTasks), [monthlyTasks]);
  reactExports.useEffect(() => {
    if (isSessionActive) return;
    const timer = setInterval(() => setPlanBaseTime(/* @__PURE__ */ new Date()), 1e3);
  ...
  const finishTime = new Date(planBaseTime.getTime() + targetHours * 60 * 60 * 1e3);
  ...
  const handleUpdateDuration = (id, change) => {
    setTasks((prev) => prev.map((t) => t.id === id ? { ...t, duration: Math.max(1, t.duration + change) } : t));
  };
  const handleSetDuration = (id, exactValue) => {
    setTasks((prev) => prev.map((t) => t.id === id ? { ...t, duration: Math.max(1, exactValue) } : t));
  };
  ...
  if (isSessionActive && playlist.length > 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(FocusMode, { playlist, settings, onTaskComplete: handleTaskCompleteRecord, onSessionComplete: () => {
    }, onExit: () => setIsSessionActive(false) });
  }
  if (view === "horizons") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(HorizonsView, { onBack: () => setView("session"), monthlyTasks, setMonthlyTasks });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(DndContext, { onDragEnd: handleDragEnd, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-screen w-screen bg-gray-900 text-white font-sans overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CustomTitleBar, { toggleAnalytics: () => setShowAnalytics(true), toggleSettings: () => setShowSettings(true) }),
    notification && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed top-12 left-1/2 -translate-x-1/2 z-[100] animate-in fade-in slide-in-from-top-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `px-6 py-3 rounded-full backdrop-blur-xl border shadow-2xl flex items-center gap-3 ${notification.type === "error" ? "bg-red-500/20 border-red-500/30 text-red-200" : "bg-emerald-500/20 border-emerald-500/30 text-emerald-200"}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-2 h-2 rounded-full ${notification.type === "error" ? "bg-red-500" : "bg-emerald-500"} animate-pulse` }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold tracking-wide", children: notification.msg })
    ] }) }),
    showAnalytics && /* @__PURE__ */ jsxRuntimeExports.jsx(AnalyticsView, { history, onClose: () => setShowAnalytics(false) }),
    showSettings && /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsView, { settings, onUpdate: (k, v) => setSettings((prev) => ({ ...prev, [k]: v })), onClose: () => setShowSettings(false) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `${isSidebarOpen ? "w-80 opacity-100 p-6" : "w-0 opacity-0 p-0"} h-full flex flex-col border-r border-white/10 bg-white/5 backdrop-blur-2xl transition-all duration-300`, children: [
          ...
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-left", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-bold text-indigo-200", children: "Plan Horizons" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-indigo-200/50", children: "Manage future tasks" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-indigo-200 group-hover:translate-x-1 transition-transform", children: "→" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs font-bold text-emerald-400 uppercase tracking-wider mb-3", children: getCurrentMonthKey() }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 max-h-[120px] overflow-y-auto pr-1", children: (monthlyTasks[getCurrentMonthKey()] || []).length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white/20 text-[10px] italic", children: "No tasks set for this month." }) : (monthlyTasks[getCurrentMonthKey()] || []).map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between bg-emerald-900/10 border border-emerald-500/20 p-2 rounded-lg group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-emerald-100/80 truncate max-w-[140px]", children: t.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 border-b border-white/5 pb-4 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setSidebarTab("backlog"), className: `text-xs font-bold uppercase tracking-wider ${sidebarTab === "backlog" ? "text-white" : "text-white/30"}`, children: "Backlog" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setSidebarTab("saved"), className: `text-xs font-bold uppercase tracking-wider ${sidebarTab === "saved" ? "text-white" : "text-white/30"}`, children: "Saved" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setSidebarTab("logbook"), className: `text-xs font-bold uppercase tracking-wider ${sidebarTab === "logbook" ? "text-white" : "text-white/30"}`, children: "Logbook" })
        ] }),
        sidebarTab === "backlog" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", value: newTaskInput, onChange: handleInputChange, onKeyDown: handleAddTask, placeholder: "Add task...", className: "w-full bg-white/5 border border-white/10 rounded-lg p-3 text-sm text-white focus:outline-none focus:border-blue-500/50" }),
            suggestions.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-full left-0 w-full mt-1 bg-gray-800 border border-white/10 rounded-lg shadow-xl z-50 overflow-hidden", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase font-bold text-white/30 px-3 py-2 bg-black/20", children: "Suggestions" }),
              suggestions.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-white/40 text-xs group-hover:text-white/70", children: [
                      s.duration,
                      "m"
                    ] })
                  ]
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 overflow-y-auto flex-1 pb-4", children: tasks.map((task) => /* @__PURE__ */ jsxRuntimeExports.jsx(DraggableTask, { ...task, onUpdateDuration: handleUpdateDuration, onSetDuration: handleSetDuration, onDelete: handleDeleteTask, onSaveTemplate: handleSaveTemplate }, task.id)) })
        ] }),
        sidebarTab === "saved" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 overflow-y-auto flex-1 pb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-white/30 text-center mb-4", children: "Drag saved tasks to timeline" }),
          templates.map((task) => /* @__PURE__ */ jsxRuntimeExports.jsx(DraggableTask, { ...task, onDelete: handleDeleteTemplate, isTemplate: true }, task.id))
        ] }),
        sidebarTab === "logbook" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 overflow-y-auto flex-1 pb-4", children: history.slice().reverse().map((h, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-lg bg-white/5 border border-white/5 flex justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium text-white/70 line-through decoration-emerald-500/50", children: h.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-white/30", children: new Date(h.timestamp).toLocaleDateString() })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-emerald-400 font-bold", children: [
            h.duration,
            "m"
          ] })
        ] }, i)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 h-full flex flex-col relative bg-black/20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-20 border-b border-white/5 flex items-center px-8 bg-white/5 backdrop-blur-sm justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-6", children: [
            !isSidebarOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setSidebarOpen(true), className: "p-2 hover:bg-white/10 rounded-lg text-white/50", children: "☰" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400", children: "Session Plan" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-emerald-400 mt-1 font-mono tracking-wide", children: [
                "Est. Finish: ",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 bg-black/20 px-3 py-1.5 rounded-lg border border-white/5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-white/40 uppercase font-bold tracking-wider", children: "Duration" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "number", min: "1", max: "12", value: targetHours, onChange: (e) => setTargetHours(parseInt(e.target.value) || 1), className: "w-8 bg-transparent text-sm font-bold text-center focus:outline-none" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold text-white", children: "Hrs" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: startSession, className: "px-6 py-2 bg-blue-500 hover:bg-blue-400 text-white font-bold rounded-lg shadow-[0_0_15px_rgba(59,130,246,0.4)] transition-all transform hover:scale-105", children: "Start Session ▶" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 p-8 pl-32 overflow-y-auto space-y-6", children: [
          Array.from({ length: targetHours }).map((_, index) => {
            const slotStartTime = new Date(planBaseTime.getTime() + index * 60 * 60 * 1e3);
            const slotEndTime = new Date(slotStartTime.getTime() + 60 * 60 * 1e3);
            return /* @__PURE__ */ jsxRuntimeExports.jsx(TimelineSlot, { index, startTime: slotStartTime, endTime: slotEndTime, tasksInSlot: schedule[index] || [], onRemoveTask: handleUnscheduleTask }, index);
          }),
...
function Widget() {
  ...
  const [peekIndex, setPeekIndex] = reactExports.useState(0);
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end items-end h-screen w-full pr-4 pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      className: `
        ...
        `,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center pl-3 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-1.5 h-1.5 rounded-full ${indicatorColor} ${data.status === "active" && peekIndex === 0 ? "animate-pulse" : ""} shadow-[0_0_6px_currentColor]` }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pl-3 font-mono font-bold text-sm text-white tracking-wider shrink-0 select-none pt-0.5", children: data.status === "transition" ? "DONE!" : data.status === "completed" ? "FINISH" : displayTime }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 h-full relative ml-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `absolute inset-0 flex items-center transition-all duration-300 ${isExpanded ? "opacity-0 translate-y-2" : "opacity-100 translate-y-0"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-white/40 truncate max-w-[90px] select-none font-medium pt-0.5", children: displayTitle }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `absolute inset-0 flex items-center gap-2 pr-3 transition-all duration-300 ${isExpanded ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-2"}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col justify-center mr-auto overflow-hidden", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[9px] uppercase font-bold tracking-wider ${data.status === "transition" ? "text-emerald-400" : "text-white/30"}`, children: data.status === "transition" ? "Completed" : data.status === "completed" ? "Session" : displayLabel }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-white font-medium truncate w-[100px]", children: displayTitle })
            ] }),
            data.status === "active" && peekIndex === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
...
if (window.location.hash === "#widget") {
  root.render(
    /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Widget, {}) })
  );
} else {
  root.render(
